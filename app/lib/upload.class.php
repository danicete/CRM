...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null) {
        ...
        // Make database entries (because I think I can assume everything worked well
        ...
        $linkData = array(
            'media_id' => $lastID,
            'unit_id' => intval($_POST['hidden-unit-value']),
            'date_created' => date("Y-m-d H:i:s")
        );
        $db->insert('media_unit_link', $linkData);
        $file->addIndex = intval($_POST['hidden-add-index']);
        $file->mediaID  = $lastID;
        return $file;
    }
    ...
    public function post() {
        ...
        $db = $this->db;
        // Before sending the response, send emails
